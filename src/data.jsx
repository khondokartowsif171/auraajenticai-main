...
const PORTFOLIO_DATA = {
  ...
  metrics: [
    { label: "Years shipping", labelBn: "বছর ধরে শিপিং", value: "7+" },
    { label: "Agents in production", labelBn: "প্রোডাকশনে এজেন্ট", value: "40+" },
    { label: "Enterprise clients", labelBn: "এন্টারপ্রাইজ ক্লায়েন্ট", value: "12" },
    { label: "Uptime maintained", labelBn: "আপটাইম বজায়", value: "99.98%" },
  ],
  ...
  about: {
    ...
    pitchBn: "আমি এমন সিস্টেম তৈরি করি যা টিমের হয়ে সরাসরি কাজ করে — এজেন্ট যা বিচার করে, route করে, সিদ্ধান্ত নেয়, এবং কাজ সম্পন্ন করে। কাজের পরিধি পুরো স্ট্যাক জুড়ে: মডেল অর্কেস্ট্রেশন, eval harness, queue ইনফ্রাস্ট্রাকচার, ড্যাশবোর্ড, on-chain settlement, এবং সেই ক্লান্তিকর সংযোগকারী কাজ যা একটা চটকদার ডেমোকে এমন কিছুতে পরিণত করে যাতে একজন CFO সই করতে রাজি হয়।",
    bullets: [
    ...
    bulletsBn: [
      "৮-অঙ্কের GMV চলমান fintech ও MLM প্ল্যাটফর্মের জন্য এজেন্ট রানটাইম ডিজাইন",
      "OpenAI, Anthropic, vLLM, এবং self-hosted মডেল জুড়ে অর্কেস্ট্রেশন লেয়ার তৈরি",
      "Web3 settlement rail শিপ করেছি — ওয়ালেট, সাইনার, on-chain অডিট ট্রেইল",
      "তিনটা SaaS ড্যাশবোর্ডের লিড আর্কিটেক্ট, যা এখন ৫০k+ দৈনিক ইউজার সার্ভ করে",
    ],
  },
  ...
  testimonials: [
    {
      ...
      textBn: "Aura একটা n8n + Claude পাইপলাইন বানিয়েছে যা আমাদের reconciliation ৫ সেকেন্ডে করে ফেলে — যা আগে আমাদের টিমের ম্যানুয়ালি ২ ঘণ্টা লাগত। সিস্টেমটা ৬ মাসে একবারও fail করেনি।",
      avatar: "FR",
      color: "cyan",
    },
    {
      ...
      textBn: "৩ মাসে EA আমাদের ম্যানুয়াল স্ট্র্যাটেজিকে ৩৪০% ছাড়িয়ে গেছে। Kill-switch ও risk envelope ফিচার আমাদের risk টিমকে স্কেল করার আত্মবিশ্বাস দিয়েছে।",
      avatar: "TH",
      color: "amber",
    },
    {
      ...
      textBn: "৮ সপ্তাহে ROAS ১.৮× থেকে ৫.২×। fatigue হওয়ার আগেই এআই creative পাল্টে দেয় — কোনো মানুষ campaign manager এত দ্রুত ধরতে পারছিল না।",
      avatar: "SM",
      color: "rose",
    },
    {
      ...
      textBn: "৬ সপ্তাহে gasless UX সহ multi-chain settlement layer ডেলিভার করেছে। on-chain audit trail-ই আমাদের convince করেছে — আমাদের compliance টিম এটা খুব পছন্দ করে।",
      avatar: "AC",
      color: "green",
    },
  ],
  ...
  experience: [
    {
      ...
      roleBn: "ফাউন্ডার ও প্রিন্সিপাল ইঞ্জিনিয়ার",
      ...
      detailBn: "এজেন্ট রানটাইম লেয়ার তৈরি করছি — অর্কেস্ট্রেশন, evals, observability — যা ১২টা এন্টারপ্রাইজ টিম ব্যবহার করে।",
    },
    {
      year: "2022 — 2024",
      role: "Staff Full-Stack Engineer",
      roleBn: "স্টাফ ফুল-স্ট্যাক ইঞ্জিনিয়ার",
      ...
      detailBn: "একটা MLM কম্পেনসেশন ইঞ্জিনের পুনর্নির্মাণের নেতৃত্ব দিয়েছি, monolith থেকে multi-tenant-এ migration চালিয়েছি।",
    },
    {
      year: "2021 — 2022",
      role: "Senior Engineer · Web3",
      roleBn: "সিনিয়র ইঞ্জিনিয়ার · ওয়েব৩",
      ...
      detailBn: "Wallet UX, signer abstraction, on-chain settlement rail। প্রোটোকল ঘোষণা করার আগেই শিপ করেছি।",
    },
    {
      year: "2019 — 2021",
      role: "Full-Stack Engineer",
      roleBn: "ফুল-স্ট্যাক ইঞ্জিনিয়ার",
      company: "Series-B SaaS",
      kind: "Full-time",
      kindBn: "ফুল-টাইম",
      detail: "Owned the dashboard surface area — billing, RBAC, integrations. Pushed app from 4k to 28k DAU.",
      detailBn: "ড্যাশবোর্ডের পুরো অংশের দায়িত্বে ছিলাম — billing, RBAC, integration। অ্যাপকে 4k থেকে 28k DAU-তে নিয়ে গেছি।",
    },
    {
      year: "2018 — 2019",
      role: "Software Engineer",
      roleBn: "সফটওয়্যার ইঞ্জিনিয়ার",
      company: "Agency · Remote",
      kind: "Full-time",
      kindBn: "ফুল-টাইম",
      detail: "Cut my teeth shipping React + Node products across e-commerce, logistics, and edtech.",
      detailBn: "e-commerce, logistics, ও edtech জুড়ে React + Node প্রোডাক্ট শিপ করে হাতেখড়ি হয়েছে।",
    },
  ],
};
